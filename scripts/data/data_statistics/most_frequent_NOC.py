...
MODELATTRPATH = "/local-scratch/localhome/hja40/Desktop/Research/proj-motionnet/2DMotion/scripts/data/data_statistics/urdf-attr.json"
...
if __name__ == "__main__":
    ...
    most_frequent_file = open(
        "/local-scratch/localhome/hja40/Desktop/Research/proj-motionnet/2DMotion/scripts/data/data_statistics/most_frequent_NOP.json",
        "w",
    )
